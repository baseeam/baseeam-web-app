...
namespace BaseEAM.Services
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        /// {0} : language Id
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_ALL_KEY = "baseeam.lsr.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// {1} : resource key
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_BY_RESOURCENAME_KEY = "baseeam.lsr.{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LOCALSTRINGRESOURCES_PATTERN_KEY = "baseeam.lsr.";
